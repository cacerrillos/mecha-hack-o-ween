...
public:
    ...
    unsigned int WriteReg( uint8_t icAddress, uint8_t WriteAddr, uint8_t WriteData );
    unsigned int ReadReg( uint8_t icAddress, uint8_t WriteAddr, uint8_t WriteData );
    void ReadRegs( uint8_t icAddress, uint8_t ReadAddr, uint8_t *ReadBuf, unsigned int Bytes );
    ...
    void closeAK8963();
    void magcalMPU9250(float * dest1, float * dest2, int sample_count, float ** sample_out);
    void my_test();
    void read_temp();
    void read_acc();
    void read_gyro();
...
public:
    ...
    float accelerometer_data_raw[3];
    float gyroscope_data[3];
    float gyroscope_data_raw[3];
    float magnetometer_data[3];
    float magnetometer_data_raw[3];
    float magnetometer_data_unscaled[3];
